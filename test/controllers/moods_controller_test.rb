...
class MoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mood" do
    assert_difference('Mood.count') do
      post moods_url, params: { mood: { db: @mood.db, name: @mood.name, rails: @mood.rails } }, as: :json
    end
  ...
  test "should update mood" do
    patch mood_url(@mood), params: { mood: { db: @mood.db, name: @mood.name, rails: @mood.rails } }, as: :json
    assert_response 200
  end
